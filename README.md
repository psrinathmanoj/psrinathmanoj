...
### Analytics Engineer · Data Pipeline Builder · Automation Specialist

I design and build **production-grade data systems** — multi-source ingestion, automated dbt transformations, CI/CD pipelines, and real-time dashboards — helping FMCG & logistics businesses move from spreadsheets to scalable data infrastructure.

> 6+ years in FMCG & Logistics · End-to-end pipeline ownership · Zero-manual-intervention data ops
